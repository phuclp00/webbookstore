...
use App\Http\Requests\BooksFormat\BooksFormat_Update;
use App\Http\Requests\BooksFormat\BooksFormatRequest;
...
class BooksFormatController extends Controller
{
    public function edit(BooksFormat_Update $request)
    {
        try {
            DB::beginTransaction();
            ...
            DB::commit();
            return \redirect()->route('admin.format');
        } catch (\Throwable $th) {
    ...
    public function add(BooksFormatRequest $request)
    {
        try {
            DB::beginTransaction();
            $product = BooksFormat::create([
                'id' => $request->id,
                'name' => $request->name,
    ...
    public function delete(Request $request)
    {
        try {
            DB::beginTransaction();
            $data = BooksFormat::where('id', $request->id)->with('books')->first();
