       ...
       <ul id="iq-sidebar-toggle" class="iq-menu">
          {{-- <li>
             ...
             <ul id="dashboard" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle"> --}}
                <li><a href="{{route('home')}}"><i class="las la-house-damage"></i>Home Page</a></li>
                <li><a href="{{route('shop')}}"><i class="ri-function-line"></i>Shop Page</a></li>
                <li><a href="{{route('blog')}}"><i class="ri-book-line"></i>Blog Page</a></li>
             {{-- </ul>
          </li> --}}
          {{-- <li> --}}
             ...
             <ul id="admin" class="iq-submenu collapse " data-parent="#iq-sidebar-toggle"> --}}
                ...
                <li><a href="{{route('admin.category')}}"><i class="ri-list-check-2"></i>Category Lists</a></li>
                <li><a href="{{route('admin.publisher')}}"><i class="ri-file-user-line"></i>Publisher</a></li>
                <li><a href="{{route('admin.books')}}"><i class="ri-book-2-line"></i>Books</a></li>
             {{-- </ul>
          </li> --}}
          {{-- <li>
             ...
             <ul id="userinfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style=""> --}}
                ...
                <li><a href="{{route('admin.register')}}"><i class="las la-plus-circle"></i>User Add</a></li>
