            ...
            <div class="iq-card">
               ...
               <div class="iq-card-header d-flex justify-content-between">
                  <div class="iq-header-title">
                     <h4 class="card-title">Edit Promotions: {{$data->name}}</h4>
                  </div>
               </div>
               @include('post.create')
               <div class="iq-card-body">
                  <form id="edit_form" action="{{route('admin.promotions.edit',[$data->id])}}" method="post"
                     enctype="multipart/form-data">
                     {{ csrf_field() }}
                     <div class="form-group">
                        <label>Promotions ID:</label>
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control"
                           ...
                           value="{{$data->name}}" aria-describedby="help_name">
                     </div>
                     <div class="form-group">
