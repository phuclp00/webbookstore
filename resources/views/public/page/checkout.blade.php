						...
						<form action="#" method="post">
							<div class="margin_between">
								<div class="input_box space_between">
									...
									<input type="text" name="username_first" value="{{$user->user_name}}">
								</div>
							</div>
							<div class="input_box">
							...
							<div class="input_box">
								...
								<select class="select__option" name="user_district">
									<option>{{$user->user_detail->district}}</option>
							...
							<div class="margin_between">
								<div class="input_box space_between">
									...
									<input type="text" name="user_phone" value="{{$user->user_detail->phone}}">
								</div>
							</div>
							<div class="input_box">
								<input type="hidden" name="user_name" value="">
								<input type="hidden" name="">
								<button type="submit" class="btn btn-cart btn-outline-danger" style="">Continue to
									checkout</button>
							</div>
						</form>
						@endif
					...
					<div class="payment">
						<div class="che__header" role="tab" id="headingFour">
							<a class="collapsed checkout__title" data-toggle="collapse" href="#collapseFour"
								...
								<span>PayPal <img src="{{asset('images/icons/payment.png')}}" alt="payment images">
								</span>
							</a>
						</div>
