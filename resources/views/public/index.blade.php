                ...
                @if($product->date_released<=20)
                    <div class="product product__style--3">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            ...
                            <a class="first__img" href="{{route('product',['id'=>$product->book_id,'cat_id'=>$product->cat_id])}}"><img src="{{asset('images/books/test_img/'.$product->img)}}" alt="product image" style="width: 270px;height: 340px;"></a>
                            <a class="second__img animation1" href="{{route('product',['id'=>$product->book_id,'cat_id'=>$product->cat_id])}}"><img src="{{asset('images/books/8k.jpg')}}" alt="product image"style="width: 270px;height: 340px;"></a>
                            ...
                            <div class="product__content content--center">
                                <h4><a href="{{route('product',['id'=>$product->book_id,'cat_id'=>$product->cat_id])}}">{{$product->book_name}}</a></h4>
                    ...
                    <div class="single__product">                       
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">  
                            <div class="product product__style--3">
                                <div class="product__thumb">
                                    <a class="first__img" href="{{ route('product',['id'=>$product->book_id,'cat_id'=>$product->cat_id])}}"><img src="{{asset('images/books/test_img/'.$product->img)}}" alt="product image" style="width: 270px;height: 340px;"></a>
                                    <a class="second__img animation1" href="{{ route('product',['id'=>$product->book_id,'cat_id'=>$product->cat_id])}}"><img src="{{asset('images/books/8k.jpg')}}" alt="product image"style="width: 270px;height: 340px;"></a>{{-- This comment will not be present in the rendered HTML 
                                        // START IF
                                        // Danh sach cac san pham moi voi ngay ra mat khong qua 30 ngay 
                                        // Neu san pham gia tren 5000 thi se la HOT   
                                     --}}
                    ...
                    <div class="single__product">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product product__style--3">
                                ...
                                <div class="product__content content--center content--center">
                                    <h4><a href="{{ route('product',['id'=>$product_tag->book_id,'cat_id'=>$product_tag->cat_id]) }}"><img src="{{asset('images/books/test_img/'.$product->img)}}">{{$product_tag->book_name}}</a></h4>
                                    <ul class="prize d-flex">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product product__style--3">
                                ...
                                <div class="product__content content--center content--center">
                                    <h4><a href="{{ route('product',['id'=>$product_tag->book_id,'cat_id'=>$product_tag->cat_id]) }}"><img src="{{asset('images/books/test_img/'.$product_tag->img)}}">{{$product_tag->book_name}}</a></h4>
                                    <ul class="prize d-flex">
                                        @if($product_tag->promotion_price>0)
                                            <li>{{number_format($product_tag->promotion_price,2)."$"}}</li>
                                            <li class="old_prize">{{number_format($product_tag->price,2)."$"}}</li>
        ...
        <div class="slider center">
            ...
            @foreach ($list_product as $item_bestseller)
                @if($item_bestseller->totall_sell>20 && $item_bestseller->first())
                    <div class="product product__style--3">
                        <div class="product__thumb">
                            <a class="first__img" href="{{ route('product',['id'=>$item_bestseller->book_id,'cat_id'=>$item_bestseller->cat_id]) }}"><img src="{{asset('images/books/test_img/'.$item_bestseller->img)}}" alt="product image"></a>
                        </div>
                        <div class="product__content content--center">
                            <div class="action">
                                <div class="actions_inner">
