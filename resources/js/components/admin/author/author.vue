  ...
  >
    ...
    <tbody>
      <tr v-for="value in authors" :key="value.id">
        ...
        <td>
          {{ value.modiffed_by == null ? value.created_by : value.modiffed_by }}
        </td>
        <td>
          <div class="flex align-items-center list-user-action">
            ...
            <a
              ...
              :href="'/admin/authors/author-edit-view/' + value.id"
            ...
            <a
              ...
              :href="'/admin/authors/author-restore/' + value.id"
            ...
            <a
              ...
              :href="'/admin/authors/author-delete/' + value.id"
    ...
    <modal-author :detail="data[0]" ref="reference"></modal-author>
  </table>
</template>

<script>
Vue.component("modal-author", require("./modal/author.vue").default);
