<template>
  ...
  >
        ...
        <td>
          <div class="flex align-items-center list-user-action">
            ...
            <a
              ...
              :href="'/admin/suppliers/supplier-edit-view/' + value.id"
            ...
            <a
              ...
              :href="'/admin/suppliers/supplier-restore/' + value.id"
            ...
            <a
              ...
              s
              :href="'/admin/suppliers/supplier-delete/' + value.id"
    ...
    <modal-supplier :detail="data[0]" ref="reference"></modal-supplier>
  </table>
</template>

<script>
import moment from "moment";
Vue.component("modal-supplier", require("./modal/supplier.vue").default);
export default {
