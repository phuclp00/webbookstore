...
(function(factory) {
    ...
    w.jconfirm = function(options) {
        ...
        if (w.jconfirm.defaults) { pluginOptions = $.extend(true, pluginOptions, w.jconfirm.defaults); }
    ...
    w.Jconfirm.prototype = {
        ...
        _buildHTML: function() {
            ...
            }).then(function() { that._watchContent(); });
        ...
        close: function(onClosePayload) {
            ...
            setTimeout(function() {
                ...
                setTimeout(function() {
                    ...
                    for (i; i >= 0; i--) { if (w.jconfirm.instances[i]._id === that._id) { w.jconfirm.instances.splice(i, 1); } }
